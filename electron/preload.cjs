...
contextBridge.exposeInMainWorld('cockpit', {
  ...
  contextCatalog: () => call('contextCatalog'),
  skillStatus: () => call('skillStatus'),
  skillInstall: () => call('skillInstall'),
  skillUninstall: () => call('skillUninstall'),
  ctxInventory: () => call('ctxInventory'),
  ctxPickDir: () => call('ctxPickDir'),
  ctxExport: (sel, opts) => call('ctxExport', sel, opts),
  ctxReveal: (dir) => call('ctxReveal', dir),
